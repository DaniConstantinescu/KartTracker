...
public class Lap {
    ...
    public Lap(Timp timp, int s1, int s2, int s3) {
        this.timp = timp;
        this.s1 = s1;
        this.s2 = s2;
        this.s3 = s3;
     ...
     * @return timplu cel mai bun din lista data pentru circuitul ales
     */
    static Timp bestLap(List<Lap> lista, LocalDate dataAleasa){
     ...
     * @return timpul ideal
     */
    static Timp idelLapTimp(List<Lap> lista, String circuit){
    ...
    static Lap idelLap(List<Lap> lista, String circuit){
        ...
        Lap l = new Lap( Timp.convertMs(s1+s2+s3), s1, s2, s3);
        return l;
    }
...
class Timp {
    ...
    static Timp convertStringToTimp(String input){

        String[] tokens= input.split(":");
        Timp t = new Timp( Integer.parseInt(tokens[0]), Integer.parseInt(tokens[1]), Integer.parseInt(tokens[2]) );
